...
#define      OV7725_OE_GPIO_PIN                       GPIO_Pin_0
...
// FIFO 读复位
#define      OV7725_RRST_GPIO_CLK                     RCC_APB2Periph_GPIOB
#define      OV7725_RRST_GPIO_PORT                    GPIOB
#define      OV7725_RRST_GPIO_PIN                     GPIO_Pin_1

// FIFO 读时钟
#define      OV7725_RCLK_GPIO_CLK                     RCC_APB2Periph_GPIOB
#define      OV7725_RCLK_GPIO_PORT                    GPIOB
#define      OV7725_RCLK_GPIO_PIN                     GPIO_Pin_2

// FIFO 写使能
#define      OV7725_WE_GPIO_CLK                       RCC_APB2Periph_GPIOA
#define      OV7725_WE_GPIO_PORT                      GPIOA
#define      OV7725_WE_GPIO_PIN                       GPIO_Pin_0
...
#define      OV7725_VSYNC_GPIO_PIN                    GPIO_Pin_4

#define      OV7725_VSYNC_EXTI_SOURCE_PORT            GPIO_PortSourceGPIOA
#define      OV7725_VSYNC_EXTI_SOURCE_PIN             GPIO_PinSource4
#define      OV7725_VSYNC_EXTI_LINE                   EXTI_Line4
#define      OV7725_VSYNC_EXTI_IRQ                    EXTI4_IRQn
#define      OV7725_VSYNC_EXTI_INT_FUNCTION           EXTI4_IRQHandler
