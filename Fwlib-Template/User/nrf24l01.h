...
#define READ_REG_CMD        	0x00  		// 兼容小马哥
#define WRITE_REG_CMD       	0x20 		// 兼容小马哥
...
#define TX_DS					0x20	// 兼容小马哥
#define RX_DR					0x40		// 兼容小马哥
#define MAX_RT					0x10		// 兼容小马哥
...
void NRF24L01_GPIO_Conf(void);						//初始化
