...
int main(void)
{
	...
	while(SD_Init())
	{
		GUI_Show12ASCII(0, 84, "SD card initialize error!", RED, BLACK);
	}
	
	GUI_Show12ASCII(0, 84, "SD card initialize OK!   ", RED, BLACK);
...
void GUI_DisplayInit(void)
{
    ...
    GUI_Show12ASCII(90, 0, "PRECHIN", RED, BLACK);
    GUI_Show12ASCII(60, 26, "www.prechin.com", RED, BLACK);
    GUI_Show12ASCII(75, 42, "SD Card test", RED, BLACK);
