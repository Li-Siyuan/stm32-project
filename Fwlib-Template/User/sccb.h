...
#define      OV7725_SIO_C_GPIO_CLK                       RCC_APB2Periph_GPIOB
#define      OV7725_SIO_C_GPIO_PORT                      GPIOB
#define      OV7725_SIO_C_GPIO_PIN                       GPIO_Pin_8

#define      OV7725_SIO_D_SCK_APBxClock_FUN              RCC_APB2PeriphClockCmd
#define      OV7725_SIO_D_GPIO_CLK                       RCC_APB2Periph_GPIOB
#define      OV7725_SIO_D_GPIO_PORT                      GPIOB
#define      OV7725_SIO_D_GPIO_PIN                       GPIO_Pin_9
